            ...
            <el-card class="box-card">
                ...
                <el-form :model="loginForm" :rules="rules" ref="loginForm">
                    ...
                    <el-form-item prop="password">
                        <el-input v-model="loginForm.password" type="password" placeholder="设定新密码"></el-input>
                    </el-form-item>
...
<style>
    .box-card{margin-top: 150px;position: relative;background-color: rgba(255, 255, 255, 0.4)}
